...
class _HomePageState extends State<HomePage> {
  ...
  static const List<Widget> pages = <Widget>[DashboardPage(), ChatPage(), ProfilePage()];
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: const Text(
              'Home',
              style:
                  TextStyle(color: Colors.black, fontFamily: 'SpaceGrotesk', fontWeight: FontWeight.w700, fontSize: 24),
            ),
