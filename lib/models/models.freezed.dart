...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthState auth, int currentIndexPage});
...
class _$AppState$ implements AppState$ {
  const _$AppState$({this.auth = const AuthState(), this.currentIndexPage = 0});
  ...
  @override
  String toString() {
    return 'AppState(auth: $auth, currentIndexPage: $currentIndexPage)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, auth, currentIndexPage);
...
abstract class AppState$ implements AppState {
  const factory AppState$({final AuthState auth, final int currentIndexPage}) = _$AppState$;
...
class _$AppUser$ implements AppUser$ {
  const _$AppUser$(
      ...
      this.imageUrl = 'https://i.postimg.cc/wMn6pgqD/Blowing-rocket-3d-cartoon-style-icon.jpg'});
